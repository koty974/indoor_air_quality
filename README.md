...
Základní myšlenka byla sestrojit platformu, která umožní vyhodnotit kvalitu ovzduší v místnosti. Konkrétně aby platforma měřila teplotu, vlhkost, kvalitu vzduchu a pevné částice. Cílem je tedy časté měření techto veličin s pomocí senzorů a zobrazení na displej. Pro řešení tohoto problému je využita vývojová deska Arduino UNO, která sesbírá, zpracuje a zobrazí data na displej.
